...
def run():
    ...
    tools = [
        {
                ...
                "description": "Search the documents from VectorDB based on a query",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "query": {
                            "type": "string",
                            "description": "The search query to retrieve relevant documents from the vector database.",
                        },
    ...
    def chatbot_response(query):
        ...
        if 'function_call' in response_message:
            ...
            if tool_name == 'search_vectorDB':
                print('here')
                relevant_documents = search_vectorDB(arguments['query'])
